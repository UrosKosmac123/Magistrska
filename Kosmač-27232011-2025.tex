...
Privzamemo, da je filtracijska funkcija zvezna in dana s kompaktnim nosilcem. Potem je filtracija enaka
\begin{align*}
...
$$
Če izberemo tak $x$, da velja $||x|| = 1$, dobimo
$$
G(\gamma) = A\gamma^{-a},
$$
...
modelov, ki si jih obravnavamo v naslednjih podrazdelkih.
